...
import type { FlyData, City } from '../types'
...
const addFlyLine = (
  ...
  const fromXyz = lon2xyz(GlobalConfig.earthRadius, fromCity.longitude, fromCity.latitude)
  const toXyz = lon2xyz(GlobalConfig.earthRadius, toCity.longitude, toCity.latitude)
